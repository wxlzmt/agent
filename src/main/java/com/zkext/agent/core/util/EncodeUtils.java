 ...
 * 4.获取byte[]的md5值<br/>
 * 5.获取字符串md5值 <br/>
 * 6.结合base64实现md5加密 <br/>
 * 7.AES加密 <br/>
 * 8.AES加密为base 64 code <br/>
 * 9.AES解密 <br/>
...
public abstract class EncodeUtils {
	 ...
	 * 随便写的
	 */
	private static final String DEFAULT_KEY = "随便写写,这里是秘钥,对称加解密";

	public static void main(String[] args) throws Exception {

		String content = "22232341fadfawfea";
	...
	public static String decrypt(String encryptStr) throws Exception {
		return aesDecrypt(encryptStr, DEFAULT_KEY);
	}
